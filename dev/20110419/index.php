		...
		<div id="header">
			...
			<div id="navigation">
				<p>
					...
					<a href="#" id="about-show" class="showLink" onclick="showHide('about');return false;">| About</a>
				</p>
				...
				<div id="about" class="more">
					<p>
						TweetingMeeting is a <a href="http://52sites.com">52sites</a> project. Find us there, or message us <a href="http://twitter.com/52sites">on Twitter</a>.
					</p>
					<p>
